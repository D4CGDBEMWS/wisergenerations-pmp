...
// ---------------------------------------------------------------------------
// The general Wiser Generations 404. Unchanged wording, moved out of
// app/not-found.tsx so the root can choose between this and the LIAP one.
// ---------------------------------------------------------------------------
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/programs"
            className="rounded-xl border border-brand-blue px-6 py-3 text-sm font-bold text-navy transition hover:bg-navy hover:text-white"
          >
            View Programs
          </Link>
          <Link
            href="/contact"
            className="rounded-xl border border-gray-300 px-6 py-3 text-sm font-bold text-gray-600 transition hover:border-brand-blue hover:text-navy"
          >
            Contact Us
          </Link>
        </div>

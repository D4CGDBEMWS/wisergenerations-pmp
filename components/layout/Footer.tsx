        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/wisergenerations" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.instagram.com/wisergenerations" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.linkedin.com/company/wiser-generations" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.youtube.com/@wisergenerations" target="_blank" rel="noopener noreferrer"
                className="text-gray-400 hover:text-gold transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-xs">
              &copy; {new Date().getFullYear()} Wiser Generations Int&apos;l. An Enterprise Academy Program. All rights reserved.
            </p>
            <p className="text-gray-600 text-xs text-center md:text-right max-w-md">
              PMP&reg;, CAPM&reg;, and PMI&reg; are registered marks of the Project Management Institute, Inc.

...
// ---------------------------------------------------------------------------
// The Living Is a Project...Are You Ready?™ hub. §4, §5.
//
    ...
    <main className="bg-white">
      ...
      <section className="bg-navy text-white">
        <div className="mx-auto max-w-5xl px-5 py-16 sm:px-8 sm:py-24">
          ...
          <p className="mt-4 text-xl text-gold sm:text-2xl">Living Is a Project...Are You Ready?™</p>
          ...
          <div className="mt-8 max-w-2xl space-y-4 text-base leading-relaxed text-gray-200 sm:text-lg">
            ...
            <p>
              Living Is a Project...Are You Ready?™ helps you assess where you are, understand what changed, protect

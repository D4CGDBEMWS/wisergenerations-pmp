...
const RESOURCES: Resource[] = [
  ...
  {
    title: 'PMP® Practice Questions — Free Sample',
    description:
      'Try 3 free PMP®-style practice questions with full answer rationales before the email gate. The full studio has 694 questions + a 200-question mock exam.',
    href: '/free-practice',
    badge: 'Free',
  },
  {

...
const upcomingWebinars = [
  ...
  },
  {
    ...
    date: 'On-Demand',
    description: 'PMI made significant changes to the PMP exam effective July 9, 2026. This recorded session breaks down every domain shift, new question type, and what it means for your prep on the current exam.',

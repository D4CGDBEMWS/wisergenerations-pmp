              ...
              <header className="bg-[#0a1628] px-6 py-4 text-white">
                      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
                                <Link href="/" className="flex items-center gap-2">
                                            ...
                                            <span className="font-semibold tracking-wide">Wiser Generations™</span>span>
                                </Link>Link>
                                <span className="text-sm text-gray-300">Enrollment confirmed</span>span>
                      </div>div>
              </header>header>
              ...
              <main className="mx-auto max-w-4xl px-4 py-10">
                      <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
                                <div className="mx-auto max-w-3xl text-center">
                                            ...
                                            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#c9a84c]">Thank you</p>p>
                                  ...
                                  {enrollment?.email && (
                        <p className="mt-3 text-sm text-gray-500">Confirmation and receipt sent to {enrollment.email}</p>p>
                                            )}
                                </div>div>
                      
                                <div className="mt-10 grid gap-6 text-left md:grid-cols-2">
                                            <div className="rounded-2xl bg-gray-50 p-6">
                                                          <h2 className="text-lg font-semibold text-[#0a1628]">What happens next?</h2>h2>
                                                          <div className="mt-4 space-y-3 text-sm text-gray-600">
                                                                          <p>1. Your receipt is emailed automatically after payment.</p>p>
                                                                          <p>2. Your student portal and onboarding details are sent by the team.</p>p>
                                                                          <p>3. You can book your kickoff call with Crystal using the link below.</p>p>
                                                                          <p>4. Study materials and next-step guidance follow after enrollment review.</p>p>
                                                          </div>div>
                                            </div>div>
                                
                                            <div className="rounded-2xl bg-[#0a1628] p-6 text-white">
                                                          <h2 className="text-lg font-semibold text-[#c9a84c]">Book your kickoff call</h2>h2>

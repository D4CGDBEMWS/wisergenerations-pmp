      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div>
          ...
          <div className="space-y-4">
            {[['Email', 'crystal@wisergenerations.com'], ['Location', 'Smyrna, GA (Metro Atlanta)'], ['Virtual', 'Nationwide via Zoom'], ['Ecosystem', 'ProjectManageAnything.com']].map(([label, value]) => (
              <div key={label}>
        ...
        <div className="bg-light-navy rounded-2xl p-8">
          ...
          <p className="text-gray-500 text-sm">Contact form coming soon. Email Crystal directly at <a href="mailto:crystal@wisergenerations.com" className="text-gold hover:underline">crystal@wisergenerations.com</a> or visit <a href="/enroll" className="text-gold hover:underline">the enrollment page</a> to get started.</p>
        </div>
      </div>
    </div>
  )

...
const posts = [
  {
    ...
    excerpt: 'PMI made significant changes to the PMP exam effective July 9, 2026. New domain weights, new question types, AI and sustainability content — here is what every aspiring PMP needs to know.',
